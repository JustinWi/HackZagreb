	...
	jQuery(document)
			.ready(
					function($) {
						...
						// remove the validator so we can get into beforeSubmit
						// on the ajaxform, which then calls the validator
						options = {
							url : 'http://CustomerDevLabs.us6.list-manage.com/subscribe/post-json?u=7de22f15c9e97df7b49df664f&id=25f38c75ad&c=?',
							type : 'GET',
							dataType : 'json',
